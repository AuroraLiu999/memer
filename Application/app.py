...
app.config['UPLOAD_PATH'] = UPLOAD_PATH # 配置默认的上传地址，全局变量（在任何函数，任何页面都可以获取）# 这行什么意思？？？？？？？？？？？
...
def index():
    if request.method == "POST":
        ...
        if login_result is not None:
            ...
            return render_template('loginsuccess.html', username = session["username"]) # 26行也有一个return，这俩一样吗？？？？？？？？？作用分别是什么？？？？？？？？？？
        else:
